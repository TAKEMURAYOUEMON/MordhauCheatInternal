...
namespace Offsets
{
	constexpr int32 GObjects          = 0x057F60B0;
	constexpr int32 AppendString      = 0x01946A10;
	constexpr int32 GNames            = 0x057DD440;
	constexpr int32 GWorld            = 0x0592C6B8;
	constexpr int32 ProcessEvent      = 0x01B6D640;
