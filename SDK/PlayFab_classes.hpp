...
public:
	TMulticastInlineDelegate<void(const struct FPlayFabBaseModel& response, class UObject* customData, bool successful)> OnPlayFabResponse; // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_40[0x2F8];                                     // 0x0040(0x02F8)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayFabAuthenticationContext*          CallAuthenticationContext;                         // 0x0338(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                     RequestJsonObj;                                    // 0x0340(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                     ResponseJsonObj;                                   // 0x0348(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("PlayFabMatchmakerAPI")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"PlayFabMatchmakerAPI")
	}
...
DUMPER7_ASSERTS_UPlayFabMatchmakerAPI;
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("PlayFabMatchmakerModelDecoder")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"PlayFabMatchmakerModelDecoder")
	}
...
DUMPER7_ASSERTS_UPlayFabMatchmakerModelDecoder;
...
// 0x0970 (0x09A0 - 0x0030)
class UPlayFabServerAPI final : public UOnlineBlueprintCallProxyBase
{
public:
	TMulticastInlineDelegate<void(const struct FPlayFabBaseModel& response, class UObject* customData, bool successful)> OnPlayFabResponse; // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_40[0x8F8];                                     // 0x0040(0x08F8)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayFabAuthenticationContext*          CallAuthenticationContext;                         // 0x0938(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                     RequestJsonObj;                                    // 0x0940(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                     ResponseJsonObj;                                   // 0x0948(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
