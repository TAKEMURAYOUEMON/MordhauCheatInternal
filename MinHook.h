 ...
 *  All rights reserved.
 *
 *  MinHook is free software. It comes without any warranty, to
...
#if !(defined(_M_IX86) || defined(__i386__) || defined(_M_X64) || defined(__x86_64__) || defined(_M_ARM64) || defined(__aarch64__))
    #error MinHook supports only x86, x64 and ARM64 systems.
#endif
...
typedef enum MH_STATUS
{
    ...
    // The hook for the specified target function is already disabled.
    MH_ERROR_DISABLED,
